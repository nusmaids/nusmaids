...
-- Started on 2015-01-25 12:28:18
...
SELECT pg_catalog.setval('jobs_id_seq', 78191, true);
...
COPY users (id, name, address, contact, username, password) FROM stdin;
\.
...
-- Completed on 2015-01-25 12:28:19
